...
static inline int8_t <SRC>_type_mask_GET( <SRC> * src ){}
static inline float <SRC>_q_GET( <SRC> * src, Vattitude_target_q * dst ){}
static inline float <SRC>_body_roll_rate_GET( <SRC> * src ){}
static inline float <SRC>_body_pitch_rate_GET( <SRC> * src ){}
static inline float <SRC>_body_yaw_rate_GET( <SRC> * src ){}
static inline float <SRC>_thrust_GET( <SRC> * src ){}
*/

#define pattitude_target_ATTITUDE_TARGET_PULL_FROM(SRC)\
    static inline void pattitude_target_ATTITUDE_TARGET_pull_from_##SRC ( SRC * src, pattitude_target_ATTITUDE_TARGET * dst) {\
        pattitude_target_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pattitude_target_type_mask_SET( SRC##_type_mask_GET(src ), dst  );\
       Vattitude_target_q item_q = pattitude_target_q_SET( NULL, dst  );\
       SRC##_q_GET( src, &item_q );\
        pattitude_target_body_roll_rate_SET( SRC##_body_roll_rate_GET(src ), dst  );\
        pattitude_target_body_pitch_rate_SET( SRC##_body_pitch_rate_GET(src ), dst  );\
        pattitude_target_body_yaw_rate_SET( SRC##_body_yaw_rate_GET(src ), dst  );\
        pattitude_target_thrust_SET( SRC##_thrust_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_count_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline bool  <SRC>_mission_type_item_exist( <SRC> * src ){}
static inline e_MAV_MISSION_TYPE <SRC>_mission_type_GET( <SRC> * src ){}
*/

#define pmission_count_MISSION_COUNT_PULL_FROM(SRC)\
    static inline void pmission_count_MISSION_COUNT_pull_from_##SRC ( SRC * src, pmission_count_MISSION_COUNT * dst) {\
        pmission_count_count_SET( SRC##_count_GET(src ), dst  );\
        pmission_count_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_count_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_count_mission_type_SET( pmission_count_MISSION_COUNT_mission_type_GET( src ),  dst  );\
    }
...
static inline float <SRC>_covariance_GET( <SRC> * src, Vglobal_position_int_cov_covariance * dst ){}
static inline bool  <SRC>_estimator_type_item_exist( <SRC> * src ){}
static inline e_MAV_ESTIMATOR_TYPE <SRC>_estimator_type_GET( <SRC> * src ){}
*/

#define pglobal_position_int_cov_GLOBAL_POSITION_INT_COV_PULL_FROM(SRC)\
    static inline void pglobal_position_int_cov_GLOBAL_POSITION_INT_COV_pull_from_##SRC ( SRC * src, pglobal_position_int_cov_GLOBAL_POSITION_INT_COV * dst) {\
        pglobal_position_int_cov_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        pglobal_position_int_cov_lat_SET( SRC##_lat_GET(src ), dst  );\
        pglobal_position_int_cov_lon_SET( SRC##_lon_GET(src ), dst  );\
        pglobal_position_int_cov_alt_SET( SRC##_alt_GET(src ), dst  );\
        pglobal_position_int_cov_relative_alt_SET( SRC##_relative_alt_GET(src ), dst  );\
        pglobal_position_int_cov_vx_SET( SRC##_vx_GET(src ), dst  );\
        pglobal_position_int_cov_vy_SET( SRC##_vy_GET(src ), dst  );\
        pglobal_position_int_cov_vz_SET( SRC##_vz_GET(src ), dst  );\
       Vglobal_position_int_cov_covariance item_covariance = pglobal_position_int_cov_covariance_SET( NULL, dst  );\
       SRC##_covariance_GET( src, &item_covariance );\
        if( SRC##_estimator_type_item_exist(src ) )\
        pglobal_position_int_cov_estimator_type_SET( pglobal_position_int_cov_GLOBAL_POSITION_INT_COV_estimator_type_GET( src ),  dst  );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline float <SRC>_p1x_GET( <SRC> * src ){}
static inline float <SRC>_p1y_GET( <SRC> * src ){}
static inline float <SRC>_p1z_GET( <SRC> * src ){}
static inline float <SRC>_p2x_GET( <SRC> * src ){}
static inline float <SRC>_p2y_GET( <SRC> * src ){}
static inline float <SRC>_p2z_GET( <SRC> * src ){}
static inline bool  <SRC>_frame_item_exist( <SRC> * src ){}
static inline e_MAV_FRAME <SRC>_frame_GET( <SRC> * src ){}
*/

#define psafety_set_allowed_area_SAFETY_SET_ALLOWED_AREA_PULL_FROM(SRC)\
    static inline void psafety_set_allowed_area_SAFETY_SET_ALLOWED_AREA_pull_from_##SRC ( SRC * src, psafety_set_allowed_area_SAFETY_SET_ALLOWED_AREA * dst) {\
        psafety_set_allowed_area_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        psafety_set_allowed_area_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        psafety_set_allowed_area_p1x_SET( SRC##_p1x_GET(src ), dst  );\
        psafety_set_allowed_area_p1y_SET( SRC##_p1y_GET(src ), dst  );\
        psafety_set_allowed_area_p1z_SET( SRC##_p1z_GET(src ), dst  );\
        psafety_set_allowed_area_p2x_SET( SRC##_p2x_GET(src ), dst  );\
        psafety_set_allowed_area_p2y_SET( SRC##_p2y_GET(src ), dst  );\
        psafety_set_allowed_area_p2z_SET( SRC##_p2z_GET(src ), dst  );\
        if( SRC##_frame_item_exist(src ) )\
        psafety_set_allowed_area_frame_SET( psafety_set_allowed_area_SAFETY_SET_ALLOWED_AREA_frame_GET( src ),  dst  );\
    }
...
static inline int8_t <SRC>_satellite_prn_GET( <SRC> * src, Vgps_status_satellite_prn * dst ){}
static inline int8_t <SRC>_satellite_used_GET( <SRC> * src, Vgps_status_satellite_used * dst ){}
static inline int8_t <SRC>_satellite_elevation_GET( <SRC> * src, Vgps_status_satellite_elevation * dst ){}
static inline int8_t <SRC>_satellite_azimuth_GET( <SRC> * src, Vgps_status_satellite_azimuth * dst ){}
static inline int8_t <SRC>_satellite_snr_GET( <SRC> * src, Vgps_status_satellite_snr * dst ){}
*/

#define pgps_status_GPS_STATUS_PULL_FROM(SRC)\
    static inline void pgps_status_GPS_STATUS_pull_from_##SRC ( SRC * src, pgps_status_GPS_STATUS * dst) {\
        pgps_status_satellites_visible_SET( SRC##_satellites_visible_GET(src ), dst  );\
       Vgps_status_satellite_prn item_satellite_prn = pgps_status_satellite_prn_SET( NULL, dst  );\
       SRC##_satellite_prn_GET( src, &item_satellite_prn );\
       Vgps_status_satellite_used item_satellite_used = pgps_status_satellite_used_SET( NULL, dst  );\
       SRC##_satellite_used_GET( src, &item_satellite_used );\
       Vgps_status_satellite_elevation item_satellite_elevation = pgps_status_satellite_elevation_SET( NULL, dst  );\
       SRC##_satellite_elevation_GET( src, &item_satellite_elevation );\
       Vgps_status_satellite_azimuth item_satellite_azimuth = pgps_status_satellite_azimuth_SET( NULL, dst  );\
       SRC##_satellite_azimuth_GET( src, &item_satellite_azimuth );\
       Vgps_status_satellite_snr item_satellite_snr = pgps_status_satellite_snr_SET( NULL, dst  );\
       SRC##_satellite_snr_GET( src, &item_satellite_snr );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline float <SRC>_param_value_GET( <SRC> * src ){}
static inline size_t  <SRC>_param_id_item_exist( <SRC> * src  ){}
static inline void <SRC>_param_id_GET( <SRC> * src, Vparam_set_param_id * dst ){}
static inline bool  <SRC>_param_type_item_exist( <SRC> * src ){}
static inline e_MAV_PARAM_TYPE <SRC>_param_type_GET( <SRC> * src ){}
*/

#define pparam_set_PARAM_SET_PULL_FROM(SRC)\
    static inline void pparam_set_PARAM_SET_pull_from_##SRC ( SRC * src, pparam_set_PARAM_SET * dst) {\
        pparam_set_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pparam_set_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pparam_set_param_value_SET( SRC##_param_value_GET(src ), dst  );\
        const size_t len_param_id = SRC##_param_id_item_exist(src );\
        if( len_param_id ){\
            Vparam_set_param_id    item_param_id = pparam_set_param_id_SET( NULL, len_param_id, dst  );\
            pparam_set_PARAM_SET_param_id_GET(src, &item_param_id );\
        }\
        if( SRC##_param_type_item_exist(src ) )\
        pparam_set_param_type_SET( pparam_set_PARAM_SET_param_type_GET( src ),  dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_chan1_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan2_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan3_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan4_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan5_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan6_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan7_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan8_raw_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
*/

#define prc_channels_override_RC_CHANNELS_OVERRIDE_PULL_FROM(SRC)\
    static inline void prc_channels_override_RC_CHANNELS_OVERRIDE_pull_from_##SRC ( SRC * src, prc_channels_override_RC_CHANNELS_OVERRIDE * dst) {\
        prc_channels_override_chan1_raw_SET( SRC##_chan1_raw_GET(src ), dst  );\
        prc_channels_override_chan2_raw_SET( SRC##_chan2_raw_GET(src ), dst  );\
        prc_channels_override_chan3_raw_SET( SRC##_chan3_raw_GET(src ), dst  );\
        prc_channels_override_chan4_raw_SET( SRC##_chan4_raw_GET(src ), dst  );\
        prc_channels_override_chan5_raw_SET( SRC##_chan5_raw_GET(src ), dst  );\
        prc_channels_override_chan6_raw_SET( SRC##_chan6_raw_GET(src ), dst  );\
        prc_channels_override_chan7_raw_SET( SRC##_chan7_raw_GET(src ), dst  );\
        prc_channels_override_chan8_raw_SET( SRC##_chan8_raw_GET(src ), dst  );\
        prc_channels_override_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        prc_channels_override_target_component_SET( SRC##_target_component_GET(src ), dst  );\
    }
...
#define pscaled_imu_SCALED_IMU_PULL_FROM(SRC)\
    static inline void pscaled_imu_SCALED_IMU_pull_from_##SRC ( SRC * src, pscaled_imu_SCALED_IMU * dst) {\
        pscaled_imu_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pscaled_imu_xacc_SET( SRC##_xacc_GET(src ), dst  );\
        pscaled_imu_yacc_SET( SRC##_yacc_GET(src ), dst  );\
        pscaled_imu_zacc_SET( SRC##_zacc_GET(src ), dst  );\
        pscaled_imu_xgyro_SET( SRC##_xgyro_GET(src ), dst  );\
        pscaled_imu_ygyro_SET( SRC##_ygyro_GET(src ), dst  );\
        pscaled_imu_zgyro_SET( SRC##_zgyro_GET(src ), dst  );\
        pscaled_imu_xmag_SET( SRC##_xmag_GET(src ), dst  );\
        pscaled_imu_ymag_SET( SRC##_ymag_GET(src ), dst  );\
        pscaled_imu_zmag_SET( SRC##_zmag_GET(src ), dst  );\
    }
...
static inline size_t  <SRC>_param_id_item_exist( <SRC> * src  ){}
static inline void <SRC>_param_id_GET( <SRC> * src, Vparam_request_read_param_id * dst ){}
*/

#define pparam_request_read_PARAM_REQUEST_READ_PULL_FROM(SRC)\
    static inline void pparam_request_read_PARAM_REQUEST_READ_pull_from_##SRC ( SRC * src, pparam_request_read_PARAM_REQUEST_READ * dst) {\
        pparam_request_read_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pparam_request_read_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pparam_request_read_param_index_SET( SRC##_param_index_GET(src ), dst  );\
        const size_t len_param_id = SRC##_param_id_item_exist(src );\
        if( len_param_id ){\
            Vparam_request_read_param_id    item_param_id = pparam_request_read_param_id_SET( NULL, len_param_id, dst  );\
            pparam_request_read_PARAM_REQUEST_READ_param_id_GET(src, &item_param_id );\
        }\
    }
...
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int8_t <SRC>_type_mask_GET( <SRC> * src ){}
static inline float <SRC>_q_GET( <SRC> * src, Vset_attitude_target_q * dst ){}
static inline float <SRC>_body_roll_rate_GET( <SRC> * src ){}
static inline float <SRC>_body_pitch_rate_GET( <SRC> * src ){}
static inline float <SRC>_body_yaw_rate_GET( <SRC> * src ){}
static inline float <SRC>_thrust_GET( <SRC> * src ){}
...
#define pset_attitude_target_SET_ATTITUDE_TARGET_PULL_FROM(SRC)\
    static inline void pset_attitude_target_SET_ATTITUDE_TARGET_pull_from_##SRC ( SRC * src, pset_attitude_target_SET_ATTITUDE_TARGET * dst) {\
        pset_attitude_target_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pset_attitude_target_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pset_attitude_target_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pset_attitude_target_type_mask_SET( SRC##_type_mask_GET(src ), dst  );\
       Vset_attitude_target_q item_q = pset_attitude_target_q_SET( NULL, dst  );\
       SRC##_q_GET( src, &item_q );\
        pset_attitude_target_body_roll_rate_SET( SRC##_body_roll_rate_GET(src ), dst  );\
        pset_attitude_target_body_pitch_rate_SET( SRC##_body_pitch_rate_GET(src ), dst  );\
        pset_attitude_target_body_yaw_rate_SET( SRC##_body_yaw_rate_GET(src ), dst  );\
        pset_attitude_target_thrust_SET( SRC##_thrust_GET(src ), dst  );\
    }
...
#define phil_state_HIL_STATE_PULL_FROM(SRC)\
    static inline void phil_state_HIL_STATE_pull_from_##SRC ( SRC * src, phil_state_HIL_STATE * dst) {\
        phil_state_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        phil_state_roll_SET( SRC##_roll_GET(src ), dst  );\
        phil_state_pitch_SET( SRC##_pitch_GET(src ), dst  );\
        phil_state_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        phil_state_rollspeed_SET( SRC##_rollspeed_GET(src ), dst  );\
        phil_state_pitchspeed_SET( SRC##_pitchspeed_GET(src ), dst  );\
        phil_state_yawspeed_SET( SRC##_yawspeed_GET(src ), dst  );\
        phil_state_lat_SET( SRC##_lat_GET(src ), dst  );\
        phil_state_lon_SET( SRC##_lon_GET(src ), dst  );\
        phil_state_alt_SET( SRC##_alt_GET(src ), dst  );\
        phil_state_vx_SET( SRC##_vx_GET(src ), dst  );\
        phil_state_vy_SET( SRC##_vy_GET(src ), dst  );\
        phil_state_vz_SET( SRC##_vz_GET(src ), dst  );\
        phil_state_xacc_SET( SRC##_xacc_GET(src ), dst  );\
        phil_state_yacc_SET( SRC##_yacc_GET(src ), dst  );\
        phil_state_zacc_SET( SRC##_zacc_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_req_message_rate_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int8_t <SRC>_req_stream_id_GET( <SRC> * src ){}
static inline int8_t <SRC>_start_stop_GET( <SRC> * src ){}
*/

#define prequest_data_stream_REQUEST_DATA_STREAM_PULL_FROM(SRC)\
    static inline void prequest_data_stream_REQUEST_DATA_STREAM_pull_from_##SRC ( SRC * src, prequest_data_stream_REQUEST_DATA_STREAM * dst) {\
        prequest_data_stream_req_message_rate_SET( SRC##_req_message_rate_GET(src ), dst  );\
        prequest_data_stream_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        prequest_data_stream_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        prequest_data_stream_req_stream_id_SET( SRC##_req_stream_id_GET(src ), dst  );\
        prequest_data_stream_start_stop_SET( SRC##_start_stop_GET(src ), dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int64_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline float <SRC>_roll_ailerons_GET( <SRC> * src ){}
static inline float <SRC>_pitch_elevator_GET( <SRC> * src ){}
static inline float <SRC>_yaw_rudder_GET( <SRC> * src ){}
static inline float <SRC>_throttle_GET( <SRC> * src ){}
static inline float <SRC>_aux1_GET( <SRC> * src ){}
static inline float <SRC>_aux2_GET( <SRC> * src ){}
static inline float <SRC>_aux3_GET( <SRC> * src ){}
static inline float <SRC>_aux4_GET( <SRC> * src ){}
static inline int8_t <SRC>_nav_mode_GET( <SRC> * src ){}
static inline bool  <SRC>_mode_item_exist( <SRC> * src ){}
static inline e_MAV_MODE <SRC>_mode_GET( <SRC> * src ){}
*/

#define phil_controls_HIL_CONTROLS_PULL_FROM(SRC)\
    static inline void phil_controls_HIL_CONTROLS_pull_from_##SRC ( SRC * src, phil_controls_HIL_CONTROLS * dst) {\
        phil_controls_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        phil_controls_roll_ailerons_SET( SRC##_roll_ailerons_GET(src ), dst  );\
        phil_controls_pitch_elevator_SET( SRC##_pitch_elevator_GET(src ), dst  );\
        phil_controls_yaw_rudder_SET( SRC##_yaw_rudder_GET(src ), dst  );\
        phil_controls_throttle_SET( SRC##_throttle_GET(src ), dst  );\
        phil_controls_aux1_SET( SRC##_aux1_GET(src ), dst  );\
        phil_controls_aux2_SET( SRC##_aux2_GET(src ), dst  );\
        phil_controls_aux3_SET( SRC##_aux3_GET(src ), dst  );\
        phil_controls_aux4_SET( SRC##_aux4_GET(src ), dst  );\
        phil_controls_nav_mode_SET( SRC##_nav_mode_GET(src ), dst  );\
        if( SRC##_mode_item_exist(src ) )\
        phil_controls_mode_SET( phil_controls_HIL_CONTROLS_mode_GET( src ),  dst  );\
    }
...
#define pparam_request_list_PARAM_REQUEST_LIST_PULL_FROM(SRC)\
    static inline void pparam_request_list_PARAM_REQUEST_LIST_pull_from_##SRC ( SRC * src, pparam_request_list_PARAM_REQUEST_LIST * dst) {\
        pparam_request_list_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pparam_request_list_target_component_SET( SRC##_target_component_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_type_mask_GET( <SRC> * src ){}
static inline int32_t <SRC>_time_boot_ms_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int32_t <SRC>_lat_int_GET( <SRC> * src ){}
static inline int32_t <SRC>_lon_int_GET( <SRC> * src ){}
static inline float <SRC>_alt_GET( <SRC> * src ){}
static inline float <SRC>_vx_GET( <SRC> * src ){}
static inline float <SRC>_vy_GET( <SRC> * src ){}
static inline float <SRC>_vz_GET( <SRC> * src ){}
static inline float <SRC>_afx_GET( <SRC> * src ){}
static inline float <SRC>_afy_GET( <SRC> * src ){}
static inline float <SRC>_afz_GET( <SRC> * src ){}
static inline float <SRC>_yaw_GET( <SRC> * src ){}
static inline float <SRC>_yaw_rate_GET( <SRC> * src ){}
static inline bool  <SRC>_coordinate_frame_item_exist( <SRC> * src ){}
static inline e_MAV_FRAME <SRC>_coordinate_frame_GET( <SRC> * src ){}
*/

#define pset_position_target_global_int_SET_POSITION_TARGET_GLOBAL_INT_PULL_FROM(SRC)\
    static inline void pset_position_target_global_int_SET_POSITION_TARGET_GLOBAL_INT_pull_from_##SRC ( SRC * src, pset_position_target_global_int_SET_POSITION_TARGET_GLOBAL_INT * dst) {\
        pset_position_target_global_int_type_mask_SET( SRC##_type_mask_GET(src ), dst  );\
        pset_position_target_global_int_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pset_position_target_global_int_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pset_position_target_global_int_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pset_position_target_global_int_lat_int_SET( SRC##_lat_int_GET(src ), dst  );\
        pset_position_target_global_int_lon_int_SET( SRC##_lon_int_GET(src ), dst  );\
        pset_position_target_global_int_alt_SET( SRC##_alt_GET(src ), dst  );\
        pset_position_target_global_int_vx_SET( SRC##_vx_GET(src ), dst  );\
        pset_position_target_global_int_vy_SET( SRC##_vy_GET(src ), dst  );\
        pset_position_target_global_int_vz_SET( SRC##_vz_GET(src ), dst  );\
        pset_position_target_global_int_afx_SET( SRC##_afx_GET(src ), dst  );\
        pset_position_target_global_int_afy_SET( SRC##_afy_GET(src ), dst  );\
        pset_position_target_global_int_afz_SET( SRC##_afz_GET(src ), dst  );\
        pset_position_target_global_int_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        pset_position_target_global_int_yaw_rate_SET( SRC##_yaw_rate_GET(src ), dst  );\
        if( SRC##_coordinate_frame_item_exist(src ) )\
        pset_position_target_global_int_coordinate_frame_SET( pset_position_target_global_int_SET_POSITION_TARGET_GLOBAL_INT_coordinate_frame_GET( src ),  dst  );\
    }
...
static inline float <SRC>_airspeed_GET( <SRC> * src ){}
static inline float <SRC>_groundspeed_GET( <SRC> * src ){}
static inline int16_t <SRC>_heading_GET( <SRC> * src ){}
static inline float <SRC>_alt_GET( <SRC> * src ){}
static inline float <SRC>_climb_GET( <SRC> * src ){}
*/

#define pvfr_hud_VFR_HUD_PULL_FROM(SRC)\
    static inline void pvfr_hud_VFR_HUD_pull_from_##SRC ( SRC * src, pvfr_hud_VFR_HUD * dst) {\
        pvfr_hud_throttle_SET( SRC##_throttle_GET(src ), dst  );\
        pvfr_hud_airspeed_SET( SRC##_airspeed_GET(src ), dst  );\
        pvfr_hud_groundspeed_SET( SRC##_groundspeed_GET(src ), dst  );\
        pvfr_hud_heading_SET( SRC##_heading_GET(src ), dst  );\
        pvfr_hud_alt_SET( SRC##_alt_GET(src ), dst  );\
        pvfr_hud_climb_SET( SRC##_climb_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_seq_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
*/

#define pmission_set_current_MISSION_SET_CURRENT_PULL_FROM(SRC)\
    static inline void pmission_set_current_MISSION_SET_CURRENT_pull_from_##SRC ( SRC * src, pmission_set_current_MISSION_SET_CURRENT * dst) {\
        pmission_set_current_seq_SET( SRC##_seq_GET(src ), dst  );\
        pmission_set_current_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_set_current_target_component_SET( SRC##_target_component_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_wp_dist_GET( <SRC> * src ){}
static inline float <SRC>_nav_roll_GET( <SRC> * src ){}
static inline float <SRC>_nav_pitch_GET( <SRC> * src ){}
static inline int16_t <SRC>_nav_bearing_GET( <SRC> * src ){}
static inline int16_t <SRC>_target_bearing_GET( <SRC> * src ){}
static inline float <SRC>_alt_error_GET( <SRC> * src ){}
static inline float <SRC>_aspd_error_GET( <SRC> * src ){}
static inline float <SRC>_xtrack_error_GET( <SRC> * src ){}
*/

#define pnav_controller_output_NAV_CONTROLLER_OUTPUT_PULL_FROM(SRC)\
    static inline void pnav_controller_output_NAV_CONTROLLER_OUTPUT_pull_from_##SRC ( SRC * src, pnav_controller_output_NAV_CONTROLLER_OUTPUT * dst) {\
        pnav_controller_output_wp_dist_SET( SRC##_wp_dist_GET(src ), dst  );\
        pnav_controller_output_nav_roll_SET( SRC##_nav_roll_GET(src ), dst  );\
        pnav_controller_output_nav_pitch_SET( SRC##_nav_pitch_GET(src ), dst  );\
        pnav_controller_output_nav_bearing_SET( SRC##_nav_bearing_GET(src ), dst  );\
        pnav_controller_output_target_bearing_SET( SRC##_target_bearing_GET(src ), dst  );\
        pnav_controller_output_alt_error_SET( SRC##_alt_error_GET(src ), dst  );\
        pnav_controller_output_aspd_error_SET( SRC##_aspd_error_GET(src ), dst  );\
        pnav_controller_output_xtrack_error_SET( SRC##_xtrack_error_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline size_t  <SRC>_key_item_exist( <SRC> * src  ){}
static inline void <SRC>_key_GET( <SRC> * src, Vauth_key_key * dst ){}
*/

#define pauth_key_AUTH_KEY_PULL_FROM(SRC)\
    static inline void pauth_key_AUTH_KEY_pull_from_##SRC ( SRC * src, pauth_key_AUTH_KEY * dst) {\
        const size_t len_key = SRC##_key_item_exist(src );\
        if( len_key ){\
            Vauth_key_key    item_key = pauth_key_key_SET( NULL, len_key, dst  );\
            pauth_key_AUTH_KEY_key_GET(src, &item_key );\
        }\
    }
...
static inline float <SRC>_vy_GET( <SRC> * src ){}
static inline float <SRC>_vz_GET( <SRC> * src ){}
static inline float <SRC>_ax_GET( <SRC> * src ){}
static inline float <SRC>_ay_GET( <SRC> * src ){}
static inline float <SRC>_az_GET( <SRC> * src ){}
static inline float <SRC>_covariance_GET( <SRC> * src, Vlocal_position_ned_cov_covariance * dst ){}
static inline bool  <SRC>_estimator_type_item_exist( <SRC> * src ){}
static inline e_MAV_ESTIMATOR_TYPE <SRC>_estimator_type_GET( <SRC> * src ){}
*/

#define plocal_position_ned_cov_LOCAL_POSITION_NED_COV_PULL_FROM(SRC)\
    static inline void plocal_position_ned_cov_LOCAL_POSITION_NED_COV_pull_from_##SRC ( SRC * src, plocal_position_ned_cov_LOCAL_POSITION_NED_COV * dst) {\
        plocal_position_ned_cov_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        plocal_position_ned_cov_x_SET( SRC##_x_GET(src ), dst  );\
        plocal_position_ned_cov_y_SET( SRC##_y_GET(src ), dst  );\
        plocal_position_ned_cov_z_SET( SRC##_z_GET(src ), dst  );\
        plocal_position_ned_cov_vx_SET( SRC##_vx_GET(src ), dst  );\
        plocal_position_ned_cov_vy_SET( SRC##_vy_GET(src ), dst  );\
        plocal_position_ned_cov_vz_SET( SRC##_vz_GET(src ), dst  );\
        plocal_position_ned_cov_ax_SET( SRC##_ax_GET(src ), dst  );\
        plocal_position_ned_cov_ay_SET( SRC##_ay_GET(src ), dst  );\
        plocal_position_ned_cov_az_SET( SRC##_az_GET(src ), dst  );\
       Vlocal_position_ned_cov_covariance item_covariance = plocal_position_ned_cov_covariance_SET( NULL, dst  );\
       SRC##_covariance_GET( src, &item_covariance );\
        if( SRC##_estimator_type_item_exist(src ) )\
        plocal_position_ned_cov_estimator_type_SET( plocal_position_ned_cov_LOCAL_POSITION_NED_COV_estimator_type_GET( src ),  dst  );\
    }
...
#define pping_PING_PULL_FROM(SRC)\
    static inline void pping_PING_pull_from_##SRC ( SRC * src, pping_PING * dst) {\
        pping_seq_SET( SRC##_seq_GET(src ), dst  );\
        pping_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        pping_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pping_target_component_SET( SRC##_target_component_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_hdg_GET( <SRC> * src ){}
static inline int32_t <SRC>_time_boot_ms_GET( <SRC> * src ){}
static inline int32_t <SRC>_lat_GET( <SRC> * src ){}
static inline int32_t <SRC>_lon_GET( <SRC> * src ){}
static inline int32_t <SRC>_alt_GET( <SRC> * src ){}
...
#define pglobal_position_int_GLOBAL_POSITION_INT_PULL_FROM(SRC)\
    static inline void pglobal_position_int_GLOBAL_POSITION_INT_pull_from_##SRC ( SRC * src, pglobal_position_int_GLOBAL_POSITION_INT * dst) {\
        pglobal_position_int_hdg_SET( SRC##_hdg_GET(src ), dst  );\
        pglobal_position_int_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pglobal_position_int_lat_SET( SRC##_lat_GET(src ), dst  );\
        pglobal_position_int_lon_SET( SRC##_lon_GET(src ), dst  );\
        pglobal_position_int_alt_SET( SRC##_alt_GET(src ), dst  );\
        pglobal_position_int_relative_alt_SET( SRC##_relative_alt_GET(src ), dst  );\
        pglobal_position_int_vx_SET( SRC##_vx_GET(src ), dst  );\
        pglobal_position_int_vy_SET( SRC##_vy_GET(src ), dst  );\
        pglobal_position_int_vz_SET( SRC##_vz_GET(src ), dst  );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int8_t <SRC>_confirmation_GET( <SRC> * src ){}
static inline float <SRC>_param1_GET( <SRC> * src ){}
static inline float <SRC>_param2_GET( <SRC> * src ){}
static inline float <SRC>_param3_GET( <SRC> * src ){}
static inline float <SRC>_param4_GET( <SRC> * src ){}
static inline float <SRC>_param5_GET( <SRC> * src ){}
static inline float <SRC>_param6_GET( <SRC> * src ){}
static inline float <SRC>_param7_GET( <SRC> * src ){}
static inline bool  <SRC>_command_item_exist( <SRC> * src ){}
static inline e_MAV_CMD <SRC>_command_GET( <SRC> * src ){}
*/

#define pcommand_long_COMMAND_LONG_PULL_FROM(SRC)\
    static inline void pcommand_long_COMMAND_LONG_pull_from_##SRC ( SRC * src, pcommand_long_COMMAND_LONG * dst) {\
        pcommand_long_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pcommand_long_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pcommand_long_confirmation_SET( SRC##_confirmation_GET(src ), dst  );\
        pcommand_long_param1_SET( SRC##_param1_GET(src ), dst  );\
        pcommand_long_param2_SET( SRC##_param2_GET(src ), dst  );\
        pcommand_long_param3_SET( SRC##_param3_GET(src ), dst  );\
        pcommand_long_param4_SET( SRC##_param4_GET(src ), dst  );\
        pcommand_long_param5_SET( SRC##_param5_GET(src ), dst  );\
        pcommand_long_param6_SET( SRC##_param6_GET(src ), dst  );\
        pcommand_long_param7_SET( SRC##_param7_GET(src ), dst  );\
        if( SRC##_command_item_exist(src ) )\
        pcommand_long_command_SET( pcommand_long_COMMAND_LONG_command_GET( src ),  dst  );\
    }
...
static inline bool  <SRC>_fix_type_item_exist( <SRC> * src ){}
static inline e_GPS_FIX_TYPE <SRC>_fix_type_GET( <SRC> * src ){}
static inline bool  <SRC>_alt_ellipsoid_item_exist( <SRC> * src ){}
static inline int32_t <SRC>_alt_ellipsoid_GET( <SRC> * src ){}
static inline bool  <SRC>_h_acc_item_exist( <SRC> * src ){}
static inline int32_t <SRC>_h_acc_GET( <SRC> * src ){}
static inline bool  <SRC>_v_acc_item_exist( <SRC> * src ){}
static inline int32_t <SRC>_v_acc_GET( <SRC> * src ){}
static inline bool  <SRC>_vel_acc_item_exist( <SRC> * src ){}
static inline int32_t <SRC>_vel_acc_GET( <SRC> * src ){}
static inline bool  <SRC>_hdg_acc_item_exist( <SRC> * src ){}
static inline int32_t <SRC>_hdg_acc_GET( <SRC> * src ){}
*/

#define pgps_raw_int_GPS_RAW_INT_PULL_FROM(SRC)\
    static inline void pgps_raw_int_GPS_RAW_INT_pull_from_##SRC ( SRC * src, pgps_raw_int_GPS_RAW_INT * dst) {\
        pgps_raw_int_eph_SET( SRC##_eph_GET(src ), dst  );\
        pgps_raw_int_epv_SET( SRC##_epv_GET(src ), dst  );\
        pgps_raw_int_vel_SET( SRC##_vel_GET(src ), dst  );\
        pgps_raw_int_cog_SET( SRC##_cog_GET(src ), dst  );\
        pgps_raw_int_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        pgps_raw_int_lat_SET( SRC##_lat_GET(src ), dst  );\
        pgps_raw_int_lon_SET( SRC##_lon_GET(src ), dst  );\
        pgps_raw_int_alt_SET( SRC##_alt_GET(src ), dst  );\
        pgps_raw_int_satellites_visible_SET( SRC##_satellites_visible_GET(src ), dst  );\
        if( SRC##_fix_type_item_exist(src ) )\
        pgps_raw_int_fix_type_SET( pgps_raw_int_GPS_RAW_INT_fix_type_GET( src ),  dst  );\
        if( SRC##_alt_ellipsoid_item_exist(src ) )\
        pgps_raw_int_alt_ellipsoid_SET( pgps_raw_int_GPS_RAW_INT_alt_ellipsoid_GET( src ),  dst  );\
        if( SRC##_h_acc_item_exist(src ) )\
        pgps_raw_int_h_acc_SET( pgps_raw_int_GPS_RAW_INT_h_acc_GET( src ),  dst  );\
        if( SRC##_v_acc_item_exist(src ) )\
        pgps_raw_int_v_acc_SET( pgps_raw_int_GPS_RAW_INT_v_acc_GET( src ),  dst  );\
        if( SRC##_vel_acc_item_exist(src ) )\
        pgps_raw_int_vel_acc_SET( pgps_raw_int_GPS_RAW_INT_vel_acc_GET( src ),  dst  );\
        if( SRC##_hdg_acc_item_exist(src ) )\
        pgps_raw_int_hdg_acc_SET( pgps_raw_int_GPS_RAW_INT_hdg_acc_GET( src ),  dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int32_t <SRC>_time_boot_ms_GET( <SRC> * src ){}
static inline int8_t <SRC>_port_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan1_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan2_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan3_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan4_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan5_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan6_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan7_scaled_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan8_scaled_GET( <SRC> * src ){}
static inline int8_t <SRC>_rssi_GET( <SRC> * src ){}
*/

#define prc_channels_scaled_RC_CHANNELS_SCALED_PULL_FROM(SRC)\
    static inline void prc_channels_scaled_RC_CHANNELS_SCALED_pull_from_##SRC ( SRC * src, prc_channels_scaled_RC_CHANNELS_SCALED * dst) {\
        prc_channels_scaled_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        prc_channels_scaled_port_SET( SRC##_port_GET(src ), dst  );\
        prc_channels_scaled_chan1_scaled_SET( SRC##_chan1_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan2_scaled_SET( SRC##_chan2_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan3_scaled_SET( SRC##_chan3_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan4_scaled_SET( SRC##_chan4_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan5_scaled_SET( SRC##_chan5_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan6_scaled_SET( SRC##_chan6_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan7_scaled_SET( SRC##_chan7_scaled_GET(src ), dst  );\
        prc_channels_scaled_chan8_scaled_SET( SRC##_chan8_scaled_GET(src ), dst  );\
        prc_channels_scaled_rssi_SET( SRC##_rssi_GET(src ), dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int64_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline int16_t <SRC>_press_abs_GET( <SRC> * src ){}
static inline int16_t <SRC>_press_diff1_GET( <SRC> * src ){}
static inline int16_t <SRC>_press_diff2_GET( <SRC> * src ){}
static inline int16_t <SRC>_temperature_GET( <SRC> * src ){}
*/

#define praw_pressure_RAW_PRESSURE_PULL_FROM(SRC)\
    static inline void praw_pressure_RAW_PRESSURE_pull_from_##SRC ( SRC * src, praw_pressure_RAW_PRESSURE * dst) {\
        praw_pressure_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        praw_pressure_press_abs_SET( SRC##_press_abs_GET(src ), dst  );\
        praw_pressure_press_diff1_SET( SRC##_press_diff1_GET(src ), dst  );\
        praw_pressure_press_diff2_SET( SRC##_press_diff2_GET(src ), dst  );\
        praw_pressure_temperature_SET( SRC##_temperature_GET(src ), dst  );\
    }
...
#define pattitude_ATTITUDE_PULL_FROM(SRC)\
    static inline void pattitude_ATTITUDE_pull_from_##SRC ( SRC * src, pattitude_ATTITUDE * dst) {\
        pattitude_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pattitude_roll_SET( SRC##_roll_GET(src ), dst  );\
        pattitude_pitch_SET( SRC##_pitch_GET(src ), dst  );\
        pattitude_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        pattitude_rollspeed_SET( SRC##_rollspeed_GET(src ), dst  );\
        pattitude_pitchspeed_SET( SRC##_pitchspeed_GET(src ), dst  );\
        pattitude_yawspeed_SET( SRC##_yawspeed_GET(src ), dst  );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int16_t <SRC>_start_index_GET( <SRC> * src ){}
static inline int16_t <SRC>_end_index_GET( <SRC> * src ){}
static inline bool  <SRC>_mission_type_item_exist( <SRC> * src ){}
static inline e_MAV_MISSION_TYPE <SRC>_mission_type_GET( <SRC> * src ){}
*/

#define pmission_write_partial_list_MISSION_WRITE_PARTIAL_LIST_PULL_FROM(SRC)\
    static inline void pmission_write_partial_list_MISSION_WRITE_PARTIAL_LIST_pull_from_##SRC ( SRC * src, pmission_write_partial_list_MISSION_WRITE_PARTIAL_LIST * dst) {\
        pmission_write_partial_list_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_write_partial_list_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pmission_write_partial_list_start_index_SET( SRC##_start_index_GET(src ), dst  );\
        pmission_write_partial_list_end_index_SET( SRC##_end_index_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_write_partial_list_mission_type_SET( pmission_write_partial_list_MISSION_WRITE_PARTIAL_LIST_mission_type_GET( src ),  dst  );\
    }
...
static inline float <SRC>_yaw_GET( <SRC> * src ){}
static inline float <SRC>_thrust_GET( <SRC> * src ){}
static inline int8_t <SRC>_mode_switch_GET( <SRC> * src ){}
static inline int8_t <SRC>_manual_override_switch_GET( <SRC> * src ){}
*/

#define pmanual_setpoint_MANUAL_SETPOINT_PULL_FROM(SRC)\
    static inline void pmanual_setpoint_MANUAL_SETPOINT_pull_from_##SRC ( SRC * src, pmanual_setpoint_MANUAL_SETPOINT * dst) {\
        pmanual_setpoint_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pmanual_setpoint_roll_SET( SRC##_roll_GET(src ), dst  );\
        pmanual_setpoint_pitch_SET( SRC##_pitch_GET(src ), dst  );\
        pmanual_setpoint_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        pmanual_setpoint_thrust_SET( SRC##_thrust_GET(src ), dst  );\
        pmanual_setpoint_mode_switch_SET( SRC##_mode_switch_GET(src ), dst  );\
        pmanual_setpoint_manual_override_switch_SET( SRC##_manual_override_switch_GET(src ), dst  );\
    }
...
#define psafety_allowed_area_SAFETY_ALLOWED_AREA_PULL_FROM(SRC)\
    static inline void psafety_allowed_area_SAFETY_ALLOWED_AREA_pull_from_##SRC ( SRC * src, psafety_allowed_area_SAFETY_ALLOWED_AREA * dst) {\
        psafety_allowed_area_p1x_SET( SRC##_p1x_GET(src ), dst  );\
        psafety_allowed_area_p1y_SET( SRC##_p1y_GET(src ), dst  );\
        psafety_allowed_area_p1z_SET( SRC##_p1z_GET(src ), dst  );\
        psafety_allowed_area_p2x_SET( SRC##_p2x_GET(src ), dst  );\
        psafety_allowed_area_p2y_SET( SRC##_p2y_GET(src ), dst  );\
        psafety_allowed_area_p2z_SET( SRC##_p2z_GET(src ), dst  );\
        if( SRC##_frame_item_exist(src ) )\
        psafety_allowed_area_frame_SET( psafety_allowed_area_SAFETY_ALLOWED_AREA_frame_GET( src ),  dst  );\
    }
...
#define pmission_clear_all_MISSION_CLEAR_ALL_PULL_FROM(SRC)\
    static inline void pmission_clear_all_MISSION_CLEAR_ALL_pull_from_##SRC ( SRC * src, pmission_clear_all_MISSION_CLEAR_ALL * dst) {\
        pmission_clear_all_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_clear_all_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_clear_all_mission_type_SET( pmission_clear_all_MISSION_CLEAR_ALL_mission_type_GET( src ),  dst  );\
    }
...
#define pscaled_pressure_SCALED_PRESSURE_PULL_FROM(SRC)\
    static inline void pscaled_pressure_SCALED_PRESSURE_pull_from_##SRC ( SRC * src, pscaled_pressure_SCALED_PRESSURE * dst) {\
        pscaled_pressure_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pscaled_pressure_press_abs_SET( SRC##_press_abs_GET(src ), dst  );\
        pscaled_pressure_press_diff_SET( SRC##_press_diff_GET(src ), dst  );\
        pscaled_pressure_temperature_SET( SRC##_temperature_GET(src ), dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int32_t <SRC>_custom_mode_GET( <SRC> * src ){}
static inline int8_t <SRC>_mavlink_version_GET( <SRC> * src ){}
static inline bool  <SRC>_typE_item_exist( <SRC> * src ){}
static inline e_MAV_TYPE <SRC>_typE_GET( <SRC> * src ){}
static inline bool  <SRC>_autopilot_item_exist( <SRC> * src ){}
static inline e_MAV_AUTOPILOT <SRC>_autopilot_GET( <SRC> * src ){}
static inline bool  <SRC>_base_mode_item_exist( <SRC> * src ){}
static inline e_MAV_MODE_FLAG <SRC>_base_mode_GET( <SRC> * src ){}
static inline bool  <SRC>_system_status_item_exist( <SRC> * src ){}
static inline e_MAV_STATE <SRC>_system_status_GET( <SRC> * src ){}
*/

#define pheartbeat_HEARTBEAT_PULL_FROM(SRC)\
    static inline void pheartbeat_HEARTBEAT_pull_from_##SRC ( SRC * src, pheartbeat_HEARTBEAT * dst) {\
        pheartbeat_custom_mode_SET( SRC##_custom_mode_GET(src ), dst  );\
        pheartbeat_mavlink_version_SET( SRC##_mavlink_version_GET(src ), dst  );\
        if( SRC##_typE_item_exist(src ) )\
        pheartbeat_typE_SET( pheartbeat_HEARTBEAT_typE_GET( src ),  dst  );\
        if( SRC##_autopilot_item_exist(src ) )\
        pheartbeat_autopilot_SET( pheartbeat_HEARTBEAT_autopilot_GET( src ),  dst  );\
        if( SRC##_base_mode_item_exist(src ) )\
        pheartbeat_base_mode_SET( pheartbeat_HEARTBEAT_base_mode_GET( src ),  dst  );\
        if( SRC##_system_status_item_exist(src ) )\
        pheartbeat_system_status_SET( pheartbeat_HEARTBEAT_system_status_GET( src ),  dst  );\
    }
...
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int16_t <SRC>_param_index_GET( <SRC> * src ){}
static inline int8_t <SRC>_parameter_rc_channel_index_GET( <SRC> * src ){}
static inline float <SRC>_param_value0_GET( <SRC> * src ){}
static inline float <SRC>_scale_GET( <SRC> * src ){}
static inline float <SRC>_param_value_min_GET( <SRC> * src ){}
static inline float <SRC>_param_value_max_GET( <SRC> * src ){}
static inline size_t  <SRC>_param_id_item_exist( <SRC> * src  ){}
static inline void <SRC>_param_id_GET( <SRC> * src, Vparam_map_rc_param_id * dst ){}
*/

#define pparam_map_rc_PARAM_MAP_RC_PULL_FROM(SRC)\
    static inline void pparam_map_rc_PARAM_MAP_RC_pull_from_##SRC ( SRC * src, pparam_map_rc_PARAM_MAP_RC * dst) {\
        pparam_map_rc_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pparam_map_rc_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pparam_map_rc_param_index_SET( SRC##_param_index_GET(src ), dst  );\
        pparam_map_rc_parameter_rc_channel_index_SET( SRC##_parameter_rc_channel_index_GET(src ), dst  );\
        pparam_map_rc_param_value0_SET( SRC##_param_value0_GET(src ), dst  );\
        pparam_map_rc_scale_SET( SRC##_scale_GET(src ), dst  );\
        pparam_map_rc_param_value_min_SET( SRC##_param_value_min_GET(src ), dst  );\
        pparam_map_rc_param_value_max_SET( SRC##_param_value_max_GET(src ), dst  );\
        const size_t len_param_id = SRC##_param_id_item_exist(src );\
        if( len_param_id ){\
            Vparam_map_rc_param_id    item_param_id = pparam_map_rc_param_id_SET( NULL, len_param_id, dst  );\
            pparam_map_rc_PARAM_MAP_RC_param_id_GET(src, &item_param_id );\
        }\
    }
...
#define pmission_request_int_MISSION_REQUEST_INT_PULL_FROM(SRC)\
    static inline void pmission_request_int_MISSION_REQUEST_INT_pull_from_##SRC ( SRC * src, pmission_request_int_MISSION_REQUEST_INT * dst) {\
        pmission_request_int_seq_SET( SRC##_seq_GET(src ), dst  );\
        pmission_request_int_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_request_int_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_request_int_mission_type_SET( pmission_request_int_MISSION_REQUEST_INT_mission_type_GET( src ),  dst  );\
    }
...
#define plocal_position_ned_system_global_offset_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_PULL_FROM(SRC)\
    static inline void plocal_position_ned_system_global_offset_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_pull_from_##SRC ( SRC * src, plocal_position_ned_system_global_offset_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET * dst) {\
        plocal_position_ned_system_global_offset_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        plocal_position_ned_system_global_offset_x_SET( SRC##_x_GET(src ), dst  );\
        plocal_position_ned_system_global_offset_y_SET( SRC##_y_GET(src ), dst  );\
        plocal_position_ned_system_global_offset_z_SET( SRC##_z_GET(src ), dst  );\
        plocal_position_ned_system_global_offset_roll_SET( SRC##_roll_GET(src ), dst  );\
        plocal_position_ned_system_global_offset_pitch_SET( SRC##_pitch_GET(src ), dst  );\
        plocal_position_ned_system_global_offset_yaw_SET( SRC##_yaw_GET(src ), dst  );\
    }
...
static inline bool  <SRC>_command_item_exist( <SRC> * src ){}
static inline e_MAV_CMD <SRC>_command_GET( <SRC> * src ){}
static inline bool  <SRC>_result_item_exist( <SRC> * src ){}
static inline e_MAV_RESULT <SRC>_result_GET( <SRC> * src ){}
static inline bool  <SRC>_progress_item_exist( <SRC> * src ){}
static inline int8_t <SRC>_progress_GET( <SRC> * src ){}
static inline bool  <SRC>_result_param2_item_exist( <SRC> * src ){}
static inline int32_t <SRC>_result_param2_GET( <SRC> * src ){}
static inline bool  <SRC>_target_system_item_exist( <SRC> * src ){}
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline bool  <SRC>_target_component_item_exist( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
*/

#define pcommand_ack_COMMAND_ACK_PULL_FROM(SRC)\
    static inline void pcommand_ack_COMMAND_ACK_pull_from_##SRC ( SRC * src, pcommand_ack_COMMAND_ACK * dst) {\
        if( SRC##_command_item_exist(src ) )\
        pcommand_ack_command_SET( pcommand_ack_COMMAND_ACK_command_GET( src ),  dst  );\
        if( SRC##_result_item_exist(src ) )\
        pcommand_ack_result_SET( pcommand_ack_COMMAND_ACK_result_GET( src ),  dst  );\
        if( SRC##_progress_item_exist(src ) )\
        pcommand_ack_progress_SET( pcommand_ack_COMMAND_ACK_progress_GET( src ),  dst  );\
        if( SRC##_result_param2_item_exist(src ) )\
        pcommand_ack_result_param2_SET( pcommand_ack_COMMAND_ACK_result_param2_GET( src ),  dst  );\
        if( SRC##_target_system_item_exist(src ) )\
        pcommand_ack_target_system_SET( pcommand_ack_COMMAND_ACK_target_system_GET( src ),  dst  );\
        if( SRC##_target_component_item_exist(src ) )\
        pcommand_ack_target_component_SET( pcommand_ack_COMMAND_ACK_target_component_GET( src ),  dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_message_rate_GET( <SRC> * src ){}
static inline int8_t <SRC>_stream_id_GET( <SRC> * src ){}
static inline int8_t <SRC>_on_off_GET( <SRC> * src ){}
*/

#define pdata_stream_DATA_STREAM_PULL_FROM(SRC)\
    static inline void pdata_stream_DATA_STREAM_pull_from_##SRC ( SRC * src, pdata_stream_DATA_STREAM * dst) {\
        pdata_stream_message_rate_SET( SRC##_message_rate_GET(src ), dst  );\
        pdata_stream_stream_id_SET( SRC##_stream_id_GET(src ), dst  );\
        pdata_stream_on_off_SET( SRC##_on_off_GET(src ), dst  );\
    }
...
#define pmission_request_MISSION_REQUEST_PULL_FROM(SRC)\
    static inline void pmission_request_MISSION_REQUEST_pull_from_##SRC ( SRC * src, pmission_request_MISSION_REQUEST * dst) {\
        pmission_request_seq_SET( SRC##_seq_GET(src ), dst  );\
        pmission_request_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_request_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_request_mission_type_SET( pmission_request_MISSION_REQUEST_mission_type_GET( src ),  dst  );\
    }
...
static inline int16_t <SRC>_chan7_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan8_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan9_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan10_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan11_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan12_raw_GET( <SRC> * src ){}
static inline int64_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline int8_t <SRC>_rssi_GET( <SRC> * src ){}
*/

#define phil_rc_inputs_raw_HIL_RC_INPUTS_RAW_PULL_FROM(SRC)\
    static inline void phil_rc_inputs_raw_HIL_RC_INPUTS_RAW_pull_from_##SRC ( SRC * src, phil_rc_inputs_raw_HIL_RC_INPUTS_RAW * dst) {\
        phil_rc_inputs_raw_chan1_raw_SET( SRC##_chan1_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan2_raw_SET( SRC##_chan2_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan3_raw_SET( SRC##_chan3_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan4_raw_SET( SRC##_chan4_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan5_raw_SET( SRC##_chan5_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan6_raw_SET( SRC##_chan6_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan7_raw_SET( SRC##_chan7_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan8_raw_SET( SRC##_chan8_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan9_raw_SET( SRC##_chan9_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan10_raw_SET( SRC##_chan10_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan11_raw_SET( SRC##_chan11_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_chan12_raw_SET( SRC##_chan12_raw_GET(src ), dst  );\
        phil_rc_inputs_raw_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        phil_rc_inputs_raw_rssi_SET( SRC##_rssi_GET(src ), dst  );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline bool  <SRC>_base_mode_item_exist( <SRC> * src ){}
static inline e_MAV_MODE <SRC>_base_mode_GET( <SRC> * src ){}
*/

#define pset_mode_SET_MODE_PULL_FROM(SRC)\
    static inline void pset_mode_SET_MODE_pull_from_##SRC ( SRC * src, pset_mode_SET_MODE * dst) {\
        pset_mode_custom_mode_SET( SRC##_custom_mode_GET(src ), dst  );\
        pset_mode_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        if( SRC##_base_mode_item_exist(src ) )\
        pset_mode_base_mode_SET( pset_mode_SET_MODE_base_mode_GET( src ),  dst  );\
    }
...
#define pposition_target_global_int_POSITION_TARGET_GLOBAL_INT_PULL_FROM(SRC)\
    static inline void pposition_target_global_int_POSITION_TARGET_GLOBAL_INT_pull_from_##SRC ( SRC * src, pposition_target_global_int_POSITION_TARGET_GLOBAL_INT * dst) {\
        pposition_target_global_int_type_mask_SET( SRC##_type_mask_GET(src ), dst  );\
        pposition_target_global_int_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pposition_target_global_int_lat_int_SET( SRC##_lat_int_GET(src ), dst  );\
        pposition_target_global_int_lon_int_SET( SRC##_lon_int_GET(src ), dst  );\
        pposition_target_global_int_alt_SET( SRC##_alt_GET(src ), dst  );\
        pposition_target_global_int_vx_SET( SRC##_vx_GET(src ), dst  );\
        pposition_target_global_int_vy_SET( SRC##_vy_GET(src ), dst  );\
        pposition_target_global_int_vz_SET( SRC##_vz_GET(src ), dst  );\
        pposition_target_global_int_afx_SET( SRC##_afx_GET(src ), dst  );\
        pposition_target_global_int_afy_SET( SRC##_afy_GET(src ), dst  );\
        pposition_target_global_int_afz_SET( SRC##_afz_GET(src ), dst  );\
        pposition_target_global_int_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        pposition_target_global_int_yaw_rate_SET( SRC##_yaw_rate_GET(src ), dst  );\
        if( SRC##_coordinate_frame_item_exist(src ) )\
        pposition_target_global_int_coordinate_frame_SET( pposition_target_global_int_POSITION_TARGET_GLOBAL_INT_coordinate_frame_GET( src ),  dst  );\
    }
...
#define prc_channels_raw_RC_CHANNELS_RAW_PULL_FROM(SRC)\
    static inline void prc_channels_raw_RC_CHANNELS_RAW_pull_from_##SRC ( SRC * src, prc_channels_raw_RC_CHANNELS_RAW * dst) {\
        prc_channels_raw_chan1_raw_SET( SRC##_chan1_raw_GET(src ), dst  );\
        prc_channels_raw_chan2_raw_SET( SRC##_chan2_raw_GET(src ), dst  );\
        prc_channels_raw_chan3_raw_SET( SRC##_chan3_raw_GET(src ), dst  );\
        prc_channels_raw_chan4_raw_SET( SRC##_chan4_raw_GET(src ), dst  );\
        prc_channels_raw_chan5_raw_SET( SRC##_chan5_raw_GET(src ), dst  );\
        prc_channels_raw_chan6_raw_SET( SRC##_chan6_raw_GET(src ), dst  );\
        prc_channels_raw_chan7_raw_SET( SRC##_chan7_raw_GET(src ), dst  );\
        prc_channels_raw_chan8_raw_SET( SRC##_chan8_raw_GET(src ), dst  );\
        prc_channels_raw_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        prc_channels_raw_port_SET( SRC##_port_GET(src ), dst  );\
        prc_channels_raw_rssi_SET( SRC##_rssi_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_servo1_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo2_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo3_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo4_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo5_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo6_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo7_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_servo8_raw_GET( <SRC> * src ){}
static inline int32_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline int8_t <SRC>_port_GET( <SRC> * src ){}
static inline bool  <SRC>_servo9_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo9_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo10_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo10_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo11_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo11_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo12_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo12_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo13_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo13_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo14_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo14_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo15_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo15_raw_GET( <SRC> * src ){}
static inline bool  <SRC>_servo16_raw_item_exist( <SRC> * src ){}
static inline int16_t <SRC>_servo16_raw_GET( <SRC> * src ){}
*/

#define pservo_output_raw_SERVO_OUTPUT_RAW_PULL_FROM(SRC)\
    static inline void pservo_output_raw_SERVO_OUTPUT_RAW_pull_from_##SRC ( SRC * src, pservo_output_raw_SERVO_OUTPUT_RAW * dst) {\
        pservo_output_raw_servo1_raw_SET( SRC##_servo1_raw_GET(src ), dst  );\
        pservo_output_raw_servo2_raw_SET( SRC##_servo2_raw_GET(src ), dst  );\
        pservo_output_raw_servo3_raw_SET( SRC##_servo3_raw_GET(src ), dst  );\
        pservo_output_raw_servo4_raw_SET( SRC##_servo4_raw_GET(src ), dst  );\
        pservo_output_raw_servo5_raw_SET( SRC##_servo5_raw_GET(src ), dst  );\
        pservo_output_raw_servo6_raw_SET( SRC##_servo6_raw_GET(src ), dst  );\
        pservo_output_raw_servo7_raw_SET( SRC##_servo7_raw_GET(src ), dst  );\
        pservo_output_raw_servo8_raw_SET( SRC##_servo8_raw_GET(src ), dst  );\
        pservo_output_raw_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        pservo_output_raw_port_SET( SRC##_port_GET(src ), dst  );\
        if( SRC##_servo9_raw_item_exist(src ) )\
        pservo_output_raw_servo9_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo9_raw_GET( src ),  dst  );\
        if( SRC##_servo10_raw_item_exist(src ) )\
        pservo_output_raw_servo10_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo10_raw_GET( src ),  dst  );\
        if( SRC##_servo11_raw_item_exist(src ) )\
        pservo_output_raw_servo11_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo11_raw_GET( src ),  dst  );\
        if( SRC##_servo12_raw_item_exist(src ) )\
        pservo_output_raw_servo12_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo12_raw_GET( src ),  dst  );\
        if( SRC##_servo13_raw_item_exist(src ) )\
        pservo_output_raw_servo13_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo13_raw_GET( src ),  dst  );\
        if( SRC##_servo14_raw_item_exist(src ) )\
        pservo_output_raw_servo14_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo14_raw_GET( src ),  dst  );\
        if( SRC##_servo15_raw_item_exist(src ) )\
        pservo_output_raw_servo15_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo15_raw_GET( src ),  dst  );\
        if( SRC##_servo16_raw_item_exist(src ) )\
        pservo_output_raw_servo16_raw_SET( pservo_output_raw_SERVO_OUTPUT_RAW_servo16_raw_GET( src ),  dst  );\
    }
...
#define pmission_item_reached_MISSION_ITEM_REACHED_PULL_FROM(SRC)\
    static inline void pmission_item_reached_MISSION_ITEM_REACHED_pull_from_##SRC ( SRC * src, pmission_item_reached_MISSION_ITEM_REACHED * dst) {\
        pmission_item_reached_seq_SET( SRC##_seq_GET(src ), dst  );\
    }
...
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline bool  <SRC>_typE_item_exist( <SRC> * src ){}
static inline e_MAV_MISSION_RESULT <SRC>_typE_GET( <SRC> * src ){}
static inline bool  <SRC>_mission_type_item_exist( <SRC> * src ){}
static inline e_MAV_MISSION_TYPE <SRC>_mission_type_GET( <SRC> * src ){}
*/

#define pmission_ack_MISSION_ACK_PULL_FROM(SRC)\
    static inline void pmission_ack_MISSION_ACK_pull_from_##SRC ( SRC * src, pmission_ack_MISSION_ACK * dst) {\
        pmission_ack_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_ack_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        if( SRC##_typE_item_exist(src ) )\
        pmission_ack_typE_SET( pmission_ack_MISSION_ACK_typE_GET( src ),  dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_ack_mission_type_SET( pmission_ack_MISSION_ACK_mission_type_GET( src ),  dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int8_t <SRC>_gcs_system_id_GET( <SRC> * src ){}
static inline int8_t <SRC>_control_request_GET( <SRC> * src ){}
static inline int8_t <SRC>_ack_GET( <SRC> * src ){}
*/

#define pchange_operator_control_ack_CHANGE_OPERATOR_CONTROL_ACK_PULL_FROM(SRC)\
    static inline void pchange_operator_control_ack_CHANGE_OPERATOR_CONTROL_ACK_pull_from_##SRC ( SRC * src, pchange_operator_control_ack_CHANGE_OPERATOR_CONTROL_ACK * dst) {\
        pchange_operator_control_ack_gcs_system_id_SET( SRC##_gcs_system_id_GET(src ), dst  );\
        pchange_operator_control_ack_control_request_SET( SRC##_control_request_GET(src ), dst  );\
        pchange_operator_control_ack_ack_SET( SRC##_ack_GET(src ), dst  );\
    }
...
#define pmission_current_MISSION_CURRENT_PULL_FROM(SRC)\
    static inline void pmission_current_MISSION_CURRENT_pull_from_##SRC ( SRC * src, pmission_current_MISSION_CURRENT * dst) {\
        pmission_current_seq_SET( SRC##_seq_GET(src ), dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int32_t <SRC>_time_boot_ms_GET( <SRC> * src ){}
static inline int64_t <SRC>_time_unix_usec_GET( <SRC> * src ){}
*/

#define psystem_time_SYSTEM_TIME_PULL_FROM(SRC)\
    static inline void psystem_time_SYSTEM_TIME_pull_from_##SRC ( SRC * src, psystem_time_SYSTEM_TIME * dst) {\
        psystem_time_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        psystem_time_time_unix_usec_SET( SRC##_time_unix_usec_GET(src ), dst  );\
    }
...
#define pvision_position_estimate_VISION_POSITION_ESTIMATE_PULL_FROM(SRC)\
    static inline void pvision_position_estimate_VISION_POSITION_ESTIMATE_pull_from_##SRC ( SRC * src, pvision_position_estimate_VISION_POSITION_ESTIMATE * dst) {\
        pvision_position_estimate_usec_SET( SRC##_usec_GET(src ), dst  );\
        pvision_position_estimate_x_SET( SRC##_x_GET(src ), dst  );\
        pvision_position_estimate_y_SET( SRC##_y_GET(src ), dst  );\
        pvision_position_estimate_z_SET( SRC##_z_GET(src ), dst  );\
        pvision_position_estimate_roll_SET( SRC##_roll_GET(src ), dst  );\
        pvision_position_estimate_pitch_SET( SRC##_pitch_GET(src ), dst  );\
        pvision_position_estimate_yaw_SET( SRC##_yaw_GET(src ), dst  );\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_buttons_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_GET( <SRC> * src ){}
static inline int16_t <SRC>_x_GET( <SRC> * src ){}
static inline int16_t <SRC>_y_GET( <SRC> * src ){}
static inline int16_t <SRC>_z_GET( <SRC> * src ){}
static inline int16_t <SRC>_r_GET( <SRC> * src ){}
*/

#define pmanual_control_MANUAL_CONTROL_PULL_FROM(SRC)\
    static inline void pmanual_control_MANUAL_CONTROL_pull_from_##SRC ( SRC * src, pmanual_control_MANUAL_CONTROL * dst) {\
        pmanual_control_buttons_SET( SRC##_buttons_GET(src ), dst  );\
        pmanual_control_target_SET( SRC##_target_GET(src ), dst  );\
        pmanual_control_x_SET( SRC##_x_GET(src ), dst  );\
        pmanual_control_y_SET( SRC##_y_GET(src ), dst  );\
        pmanual_control_z_SET( SRC##_z_GET(src ), dst  );\
        pmanual_control_r_SET( SRC##_r_GET(src ), dst  );\
    }
...
static inline int16_t <SRC>_chan11_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan12_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan13_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan14_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan15_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan16_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan17_raw_GET( <SRC> * src ){}
static inline int16_t <SRC>_chan18_raw_GET( <SRC> * src ){}
static inline int32_t <SRC>_time_boot_ms_GET( <SRC> * src ){}
static inline int8_t <SRC>_chancount_GET( <SRC> * src ){}
static inline int8_t <SRC>_rssi_GET( <SRC> * src ){}
*/

#define prc_channels_RC_CHANNELS_PULL_FROM(SRC)\
    static inline void prc_channels_RC_CHANNELS_pull_from_##SRC ( SRC * src, prc_channels_RC_CHANNELS * dst) {\
        prc_channels_chan1_raw_SET( SRC##_chan1_raw_GET(src ), dst  );\
        prc_channels_chan2_raw_SET( SRC##_chan2_raw_GET(src ), dst  );\
        prc_channels_chan3_raw_SET( SRC##_chan3_raw_GET(src ), dst  );\
        prc_channels_chan4_raw_SET( SRC##_chan4_raw_GET(src ), dst  );\
        prc_channels_chan5_raw_SET( SRC##_chan5_raw_GET(src ), dst  );\
        prc_channels_chan6_raw_SET( SRC##_chan6_raw_GET(src ), dst  );\
        prc_channels_chan7_raw_SET( SRC##_chan7_raw_GET(src ), dst  );\
        prc_channels_chan8_raw_SET( SRC##_chan8_raw_GET(src ), dst  );\
        prc_channels_chan9_raw_SET( SRC##_chan9_raw_GET(src ), dst  );\
        prc_channels_chan10_raw_SET( SRC##_chan10_raw_GET(src ), dst  );\
        prc_channels_chan11_raw_SET( SRC##_chan11_raw_GET(src ), dst  );\
        prc_channels_chan12_raw_SET( SRC##_chan12_raw_GET(src ), dst  );\
        prc_channels_chan13_raw_SET( SRC##_chan13_raw_GET(src ), dst  );\
        prc_channels_chan14_raw_SET( SRC##_chan14_raw_GET(src ), dst  );\
        prc_channels_chan15_raw_SET( SRC##_chan15_raw_GET(src ), dst  );\
        prc_channels_chan16_raw_SET( SRC##_chan16_raw_GET(src ), dst  );\
        prc_channels_chan17_raw_SET( SRC##_chan17_raw_GET(src ), dst  );\
        prc_channels_chan18_raw_SET( SRC##_chan18_raw_GET(src ), dst  );\
        prc_channels_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        prc_channels_chancount_SET( SRC##_chancount_GET(src ), dst  );\
        prc_channels_rssi_SET( SRC##_rssi_GET(src ), dst  );\
    }
...
static inline float <SRC>_param_value_GET( <SRC> * src ){}
static inline size_t  <SRC>_param_id_item_exist( <SRC> * src  ){}
static inline void <SRC>_param_id_GET( <SRC> * src, Vparam_value_param_id * dst ){}
static inline bool  <SRC>_param_type_item_exist( <SRC> * src ){}
static inline e_MAV_PARAM_TYPE <SRC>_param_type_GET( <SRC> * src ){}
*/

#define pparam_value_PARAM_VALUE_PULL_FROM(SRC)\
    static inline void pparam_value_PARAM_VALUE_pull_from_##SRC ( SRC * src, pparam_value_PARAM_VALUE * dst) {\
        pparam_value_param_count_SET( SRC##_param_count_GET(src ), dst  );\
        pparam_value_param_index_SET( SRC##_param_index_GET(src ), dst  );\
        pparam_value_param_value_SET( SRC##_param_value_GET(src ), dst  );\
        const size_t len_param_id = SRC##_param_id_item_exist(src );\
        if( len_param_id ){\
            Vparam_value_param_id    item_param_id = pparam_value_param_id_SET( NULL, len_param_id, dst  );\
            pparam_value_PARAM_VALUE_param_id_GET(src, &item_param_id );\
        }\
        if( SRC##_param_type_item_exist(src ) )\
        pparam_value_param_type_SET( pparam_value_PARAM_VALUE_param_type_GET( src ),  dst  );\
    }
...
#define pset_position_target_local_ned_SET_POSITION_TARGET_LOCAL_NED_PULL_FROM(SRC)\
    static inline void pset_position_target_local_ned_SET_POSITION_TARGET_LOCAL_NED_pull_from_##SRC ( SRC * src, pset_position_target_local_ned_SET_POSITION_TARGET_LOCAL_NED * dst) {\
        pset_position_target_local_ned_type_mask_SET( SRC##_type_mask_GET(src ), dst  );\
        pset_position_target_local_ned_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pset_position_target_local_ned_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pset_position_target_local_ned_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pset_position_target_local_ned_x_SET( SRC##_x_GET(src ), dst  );\
        pset_position_target_local_ned_y_SET( SRC##_y_GET(src ), dst  );\
        pset_position_target_local_ned_z_SET( SRC##_z_GET(src ), dst  );\
        pset_position_target_local_ned_vx_SET( SRC##_vx_GET(src ), dst  );\
        pset_position_target_local_ned_vy_SET( SRC##_vy_GET(src ), dst  );\
        pset_position_target_local_ned_vz_SET( SRC##_vz_GET(src ), dst  );\
        pset_position_target_local_ned_afx_SET( SRC##_afx_GET(src ), dst  );\
        pset_position_target_local_ned_afy_SET( SRC##_afy_GET(src ), dst  );\
        pset_position_target_local_ned_afz_SET( SRC##_afz_GET(src ), dst  );\
        pset_position_target_local_ned_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        pset_position_target_local_ned_yaw_rate_SET( SRC##_yaw_rate_GET(src ), dst  );\
        if( SRC##_coordinate_frame_item_exist(src ) )\
        pset_position_target_local_ned_coordinate_frame_SET( pset_position_target_local_ned_SET_POSITION_TARGET_LOCAL_NED_coordinate_frame_GET( src ),  dst  );\
    }
...
#define pset_gps_global_origin_SET_GPS_GLOBAL_ORIGIN_PULL_FROM(SRC)\
    static inline void pset_gps_global_origin_SET_GPS_GLOBAL_ORIGIN_pull_from_##SRC ( SRC * src, pset_gps_global_origin_SET_GPS_GLOBAL_ORIGIN * dst) {\
        pset_gps_global_origin_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pset_gps_global_origin_latitude_SET( SRC##_latitude_GET(src ), dst  );\
        pset_gps_global_origin_longitude_SET( SRC##_longitude_GET(src ), dst  );\
        pset_gps_global_origin_altitude_SET( SRC##_altitude_GET(src ), dst  );\
        if( SRC##_time_usec_item_exist(src ) )\
        pset_gps_global_origin_time_usec_SET( pset_gps_global_origin_SET_GPS_GLOBAL_ORIGIN_time_usec_GET( src ),  dst  );\
    }
...
#define pmission_request_list_MISSION_REQUEST_LIST_PULL_FROM(SRC)\
    static inline void pmission_request_list_MISSION_REQUEST_LIST_pull_from_##SRC ( SRC * src, pmission_request_list_MISSION_REQUEST_LIST * dst) {\
        pmission_request_list_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_request_list_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_request_list_mission_type_SET( pmission_request_list_MISSION_REQUEST_LIST_mission_type_GET( src ),  dst  );\
    }
...
#define pmission_request_partial_list_MISSION_REQUEST_PARTIAL_LIST_PULL_FROM(SRC)\
    static inline void pmission_request_partial_list_MISSION_REQUEST_PARTIAL_LIST_pull_from_##SRC ( SRC * src, pmission_request_partial_list_MISSION_REQUEST_PARTIAL_LIST * dst) {\
        pmission_request_partial_list_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_request_partial_list_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pmission_request_partial_list_start_index_SET( SRC##_start_index_GET(src ), dst  );\
        pmission_request_partial_list_end_index_SET( SRC##_end_index_GET(src ), dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_request_partial_list_mission_type_SET( pmission_request_partial_list_MISSION_REQUEST_PARTIAL_LIST_mission_type_GET( src ),  dst  );\
    }
...
#define plocal_position_ned_LOCAL_POSITION_NED_PULL_FROM(SRC)\
    static inline void plocal_position_ned_LOCAL_POSITION_NED_pull_from_##SRC ( SRC * src, plocal_position_ned_LOCAL_POSITION_NED * dst) {\
        plocal_position_ned_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        plocal_position_ned_x_SET( SRC##_x_GET(src ), dst  );\
        plocal_position_ned_y_SET( SRC##_y_GET(src ), dst  );\
        plocal_position_ned_z_SET( SRC##_z_GET(src ), dst  );\
        plocal_position_ned_vx_SET( SRC##_vx_GET(src ), dst  );\
        plocal_position_ned_vy_SET( SRC##_vy_GET(src ), dst  );\
        plocal_position_ned_vz_SET( SRC##_vz_GET(src ), dst  );\
    }
...
#define pgps_global_origin_GPS_GLOBAL_ORIGIN_PULL_FROM(SRC)\
    static inline void pgps_global_origin_GPS_GLOBAL_ORIGIN_pull_from_##SRC ( SRC * src, pgps_global_origin_GPS_GLOBAL_ORIGIN * dst) {\
        pgps_global_origin_latitude_SET( SRC##_latitude_GET(src ), dst  );\
        pgps_global_origin_longitude_SET( SRC##_longitude_GET(src ), dst  );\
        pgps_global_origin_altitude_SET( SRC##_altitude_GET(src ), dst  );\
        if( SRC##_time_usec_item_exist(src ) )\
        pgps_global_origin_time_usec_SET( pgps_global_origin_GPS_GLOBAL_ORIGIN_time_usec_GET( src ),  dst  );\
    }
...
#define pattitude_quaternion_ATTITUDE_QUATERNION_PULL_FROM(SRC)\
    static inline void pattitude_quaternion_ATTITUDE_QUATERNION_pull_from_##SRC ( SRC * src, pattitude_quaternion_ATTITUDE_QUATERNION * dst) {\
        pattitude_quaternion_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pattitude_quaternion_q1_SET( SRC##_q1_GET(src ), dst  );\
        pattitude_quaternion_q2_SET( SRC##_q2_GET(src ), dst  );\
        pattitude_quaternion_q3_SET( SRC##_q3_GET(src ), dst  );\
        pattitude_quaternion_q4_SET( SRC##_q4_GET(src ), dst  );\
        pattitude_quaternion_rollspeed_SET( SRC##_rollspeed_GET(src ), dst  );\
        pattitude_quaternion_pitchspeed_SET( SRC##_pitchspeed_GET(src ), dst  );\
        pattitude_quaternion_yawspeed_SET( SRC##_yawspeed_GET(src ), dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int64_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline int64_t <SRC>_flags_GET( <SRC> * src ){}
static inline float <SRC>_controls_GET( <SRC> * src, Vhil_actuator_controls_controls * dst ){}
static inline bool  <SRC>_mode_item_exist( <SRC> * src ){}
static inline e_MAV_MODE <SRC>_mode_GET( <SRC> * src ){}
*/

#define phil_actuator_controls_HIL_ACTUATOR_CONTROLS_PULL_FROM(SRC)\
    static inline void phil_actuator_controls_HIL_ACTUATOR_CONTROLS_pull_from_##SRC ( SRC * src, phil_actuator_controls_HIL_ACTUATOR_CONTROLS * dst) {\
        phil_actuator_controls_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        phil_actuator_controls_flags_SET( SRC##_flags_GET(src ), dst  );\
       Vhil_actuator_controls_controls item_controls = phil_actuator_controls_controls_SET( NULL, dst  );\
       SRC##_controls_GET( src, &item_controls );\
        if( SRC##_mode_item_exist(src ) )\
        phil_actuator_controls_mode_SET( phil_actuator_controls_HIL_ACTUATOR_CONTROLS_mode_GET( src ),  dst  );\
    }
...
#define pposition_target_local_ned_POSITION_TARGET_LOCAL_NED_PULL_FROM(SRC)\
    static inline void pposition_target_local_ned_POSITION_TARGET_LOCAL_NED_pull_from_##SRC ( SRC * src, pposition_target_local_ned_POSITION_TARGET_LOCAL_NED * dst) {\
        pposition_target_local_ned_type_mask_SET( SRC##_type_mask_GET(src ), dst  );\
        pposition_target_local_ned_time_boot_ms_SET( SRC##_time_boot_ms_GET(src ), dst  );\
        pposition_target_local_ned_x_SET( SRC##_x_GET(src ), dst  );\
        pposition_target_local_ned_y_SET( SRC##_y_GET(src ), dst  );\
        pposition_target_local_ned_z_SET( SRC##_z_GET(src ), dst  );\
        pposition_target_local_ned_vx_SET( SRC##_vx_GET(src ), dst  );\
        pposition_target_local_ned_vy_SET( SRC##_vy_GET(src ), dst  );\
        pposition_target_local_ned_vz_SET( SRC##_vz_GET(src ), dst  );\
        pposition_target_local_ned_afx_SET( SRC##_afx_GET(src ), dst  );\
        pposition_target_local_ned_afy_SET( SRC##_afy_GET(src ), dst  );\
        pposition_target_local_ned_afz_SET( SRC##_afz_GET(src ), dst  );\
        pposition_target_local_ned_yaw_SET( SRC##_yaw_GET(src ), dst  );\
        pposition_target_local_ned_yaw_rate_SET( SRC##_yaw_rate_GET(src ), dst  );\
        if( SRC##_coordinate_frame_item_exist(src ) )\
        pposition_target_local_ned_coordinate_frame_SET( pposition_target_local_ned_POSITION_TARGET_LOCAL_NED_coordinate_frame_GET( src ),  dst  );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_control_request_GET( <SRC> * src ){}
static inline int8_t <SRC>_version_GET( <SRC> * src ){}
static inline size_t  <SRC>_passkey_item_exist( <SRC> * src  ){}
static inline void <SRC>_passkey_GET( <SRC> * src, Vchange_operator_control_passkey * dst ){}
*/

#define pchange_operator_control_CHANGE_OPERATOR_CONTROL_PULL_FROM(SRC)\
    static inline void pchange_operator_control_CHANGE_OPERATOR_CONTROL_pull_from_##SRC ( SRC * src, pchange_operator_control_CHANGE_OPERATOR_CONTROL * dst) {\
        pchange_operator_control_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pchange_operator_control_control_request_SET( SRC##_control_request_GET(src ), dst  );\
        pchange_operator_control_version_SET( SRC##_version_GET(src ), dst  );\
        const size_t len_passkey = SRC##_passkey_item_exist(src );\
        if( len_passkey ){\
            Vchange_operator_control_passkey    item_passkey = pchange_operator_control_passkey_SET( NULL, len_passkey, dst  );\
            pchange_operator_control_CHANGE_OPERATOR_CONTROL_passkey_GET(src, &item_passkey );\
        }\
    }
...
/*The macro to simplify writing code to import data into the pack from external sources.
* Macro is expecting and calls the following functions..
static inline int16_t <SRC>_load_GET( <SRC> * src ){}
static inline int16_t <SRC>_voltage_battery_GET( <SRC> * src ){}
static inline int16_t <SRC>_drop_rate_comm_GET( <SRC> * src ){}
static inline int16_t <SRC>_errors_comm_GET( <SRC> * src ){}
static inline int16_t <SRC>_errors_count1_GET( <SRC> * src ){}
static inline int16_t <SRC>_errors_count2_GET( <SRC> * src ){}
static inline int16_t <SRC>_errors_count3_GET( <SRC> * src ){}
static inline int16_t <SRC>_errors_count4_GET( <SRC> * src ){}
static inline int16_t <SRC>_current_battery_GET( <SRC> * src ){}
static inline int8_t <SRC>_battery_remaining_GET( <SRC> * src ){}
static inline bool  <SRC>_onboard_control_sensors_present_item_exist( <SRC> * src ){}
static inline e_MAV_SYS_STATUS_SENSOR <SRC>_onboard_control_sensors_present_GET( <SRC> * src ){}
static inline bool  <SRC>_onboard_control_sensors_enabled_item_exist( <SRC> * src ){}
static inline e_MAV_SYS_STATUS_SENSOR <SRC>_onboard_control_sensors_enabled_GET( <SRC> * src ){}
static inline bool  <SRC>_onboard_control_sensors_health_item_exist( <SRC> * src ){}
static inline e_MAV_SYS_STATUS_SENSOR <SRC>_onboard_control_sensors_health_GET( <SRC> * src ){}
*/

#define psys_status_SYS_STATUS_PULL_FROM(SRC)\
    static inline void psys_status_SYS_STATUS_pull_from_##SRC ( SRC * src, psys_status_SYS_STATUS * dst) {\
        psys_status_load_SET( SRC##_load_GET(src ), dst  );\
        psys_status_voltage_battery_SET( SRC##_voltage_battery_GET(src ), dst  );\
        psys_status_drop_rate_comm_SET( SRC##_drop_rate_comm_GET(src ), dst  );\
        psys_status_errors_comm_SET( SRC##_errors_comm_GET(src ), dst  );\
        psys_status_errors_count1_SET( SRC##_errors_count1_GET(src ), dst  );\
        psys_status_errors_count2_SET( SRC##_errors_count2_GET(src ), dst  );\
        psys_status_errors_count3_SET( SRC##_errors_count3_GET(src ), dst  );\
        psys_status_errors_count4_SET( SRC##_errors_count4_GET(src ), dst  );\
        psys_status_current_battery_SET( SRC##_current_battery_GET(src ), dst  );\
        psys_status_battery_remaining_SET( SRC##_battery_remaining_GET(src ), dst  );\
        if( SRC##_onboard_control_sensors_present_item_exist(src ) )\
        psys_status_onboard_control_sensors_present_SET( psys_status_SYS_STATUS_onboard_control_sensors_present_GET( src ),  dst  );\
        if( SRC##_onboard_control_sensors_enabled_item_exist(src ) )\
        psys_status_onboard_control_sensors_enabled_SET( psys_status_SYS_STATUS_onboard_control_sensors_enabled_GET( src ),  dst  );\
        if( SRC##_onboard_control_sensors_health_item_exist(src ) )\
        psys_status_onboard_control_sensors_health_SET( psys_status_SYS_STATUS_onboard_control_sensors_health_GET( src ),  dst  );\
    }
...
static inline int8_t <SRC>_target_system_GET( <SRC> * src ){}
static inline int8_t <SRC>_target_component_GET( <SRC> * src ){}
static inline int8_t <SRC>_current_GET( <SRC> * src ){}
static inline int8_t <SRC>_autocontinue_GET( <SRC> * src ){}
static inline float <SRC>_param1_GET( <SRC> * src ){}
static inline float <SRC>_param2_GET( <SRC> * src ){}
static inline float <SRC>_param3_GET( <SRC> * src ){}
static inline float <SRC>_param4_GET( <SRC> * src ){}
...
#define pmission_item_MISSION_ITEM_PULL_FROM(SRC)\
    static inline void pmission_item_MISSION_ITEM_pull_from_##SRC ( SRC * src, pmission_item_MISSION_ITEM * dst) {\
        pmission_item_seq_SET( SRC##_seq_GET(src ), dst  );\
        pmission_item_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_item_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pmission_item_current_SET( SRC##_current_GET(src ), dst  );\
        pmission_item_autocontinue_SET( SRC##_autocontinue_GET(src ), dst  );\
        pmission_item_param1_SET( SRC##_param1_GET(src ), dst  );\
        pmission_item_param2_SET( SRC##_param2_GET(src ), dst  );\
        pmission_item_param3_SET( SRC##_param3_GET(src ), dst  );\
        pmission_item_param4_SET( SRC##_param4_GET(src ), dst  );\
        pmission_item_x_SET( SRC##_x_GET(src ), dst  );\
        pmission_item_y_SET( SRC##_y_GET(src ), dst  );\
        pmission_item_z_SET( SRC##_z_GET(src ), dst  );\
        if( SRC##_frame_item_exist(src ) )\
        pmission_item_frame_SET( pmission_item_MISSION_ITEM_frame_GET( src ),  dst  );\
        if( SRC##_command_item_exist(src ) )\
        pmission_item_command_SET( pmission_item_MISSION_ITEM_command_GET( src ),  dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_item_mission_type_SET( pmission_item_MISSION_ITEM_mission_type_GET( src ),  dst  );\
    }
...
#define praw_imu_RAW_IMU_PULL_FROM(SRC)\
    static inline void praw_imu_RAW_IMU_pull_from_##SRC ( SRC * src, praw_imu_RAW_IMU * dst) {\
        praw_imu_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        praw_imu_xacc_SET( SRC##_xacc_GET(src ), dst  );\
        praw_imu_yacc_SET( SRC##_yacc_GET(src ), dst  );\
        praw_imu_zacc_SET( SRC##_zacc_GET(src ), dst  );\
        praw_imu_xgyro_SET( SRC##_xgyro_GET(src ), dst  );\
        praw_imu_ygyro_SET( SRC##_ygyro_GET(src ), dst  );\
        praw_imu_zgyro_SET( SRC##_zgyro_GET(src ), dst  );\
        praw_imu_xmag_SET( SRC##_xmag_GET(src ), dst  );\
        praw_imu_ymag_SET( SRC##_ymag_GET(src ), dst  );\
        praw_imu_zmag_SET( SRC##_zmag_GET(src ), dst  );\
    }
...
static inline float <SRC>_param3_GET( <SRC> * src ){}
static inline float <SRC>_param4_GET( <SRC> * src ){}
static inline int32_t <SRC>_x_GET( <SRC> * src ){}
static inline int32_t <SRC>_y_GET( <SRC> * src ){}
static inline float <SRC>_z_GET( <SRC> * src ){}
static inline bool  <SRC>_frame_item_exist( <SRC> * src ){}
static inline e_MAV_FRAME <SRC>_frame_GET( <SRC> * src ){}
static inline bool  <SRC>_command_item_exist( <SRC> * src ){}
...
#define pcommand_int_COMMAND_INT_PULL_FROM(SRC)\
    static inline void pcommand_int_COMMAND_INT_pull_from_##SRC ( SRC * src, pcommand_int_COMMAND_INT * dst) {\
        pcommand_int_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pcommand_int_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pcommand_int_current_SET( SRC##_current_GET(src ), dst  );\
        pcommand_int_autocontinue_SET( SRC##_autocontinue_GET(src ), dst  );\
        pcommand_int_param1_SET( SRC##_param1_GET(src ), dst  );\
        pcommand_int_param2_SET( SRC##_param2_GET(src ), dst  );\
        pcommand_int_param3_SET( SRC##_param3_GET(src ), dst  );\
        pcommand_int_param4_SET( SRC##_param4_GET(src ), dst  );\
        pcommand_int_x_SET( SRC##_x_GET(src ), dst  );\
        pcommand_int_y_SET( SRC##_y_GET(src ), dst  );\
        pcommand_int_z_SET( SRC##_z_GET(src ), dst  );\
        if( SRC##_frame_item_exist(src ) )\
        pcommand_int_frame_SET( pcommand_int_COMMAND_INT_frame_GET( src ),  dst  );\
        if( SRC##_command_item_exist(src ) )\
        pcommand_int_command_SET( pcommand_int_COMMAND_INT_command_GET( src ),  dst  );\
    }
...
static inline int64_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline int8_t <SRC>_sensor_id_GET( <SRC> * src ){}
static inline int16_t <SRC>_flow_x_GET( <SRC> * src ){}
static inline int16_t <SRC>_flow_y_GET( <SRC> * src ){}
static inline float <SRC>_flow_comp_m_x_GET( <SRC> * src ){}
static inline float <SRC>_flow_comp_m_y_GET( <SRC> * src ){}
static inline int8_t <SRC>_quality_GET( <SRC> * src ){}
static inline float <SRC>_ground_distance_GET( <SRC> * src ){}
static inline bool  <SRC>_flow_rate_x_item_exist( <SRC> * src ){}
static inline float <SRC>_flow_rate_x_GET( <SRC> * src ){}
static inline bool  <SRC>_flow_rate_y_item_exist( <SRC> * src ){}
static inline float <SRC>_flow_rate_y_GET( <SRC> * src ){}
*/

#define poptical_flow_OPTICAL_FLOW_PULL_FROM(SRC)\
    static inline void poptical_flow_OPTICAL_FLOW_pull_from_##SRC ( SRC * src, poptical_flow_OPTICAL_FLOW * dst) {\
        poptical_flow_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
        poptical_flow_sensor_id_SET( SRC##_sensor_id_GET(src ), dst  );\
        poptical_flow_flow_x_SET( SRC##_flow_x_GET(src ), dst  );\
        poptical_flow_flow_y_SET( SRC##_flow_y_GET(src ), dst  );\
        poptical_flow_flow_comp_m_x_SET( SRC##_flow_comp_m_x_GET(src ), dst  );\
        poptical_flow_flow_comp_m_y_SET( SRC##_flow_comp_m_y_GET(src ), dst  );\
        poptical_flow_quality_SET( SRC##_quality_GET(src ), dst  );\
        poptical_flow_ground_distance_SET( SRC##_ground_distance_GET(src ), dst  );\
        if( SRC##_flow_rate_x_item_exist(src ) )\
        poptical_flow_flow_rate_x_SET( poptical_flow_OPTICAL_FLOW_flow_rate_x_GET( src ),  dst  );\
        if( SRC##_flow_rate_y_item_exist(src ) )\
        poptical_flow_flow_rate_y_SET( poptical_flow_OPTICAL_FLOW_flow_rate_y_GET( src ),  dst  );\
    }
...
#define pmission_item_int_MISSION_ITEM_INT_PULL_FROM(SRC)\
    static inline void pmission_item_int_MISSION_ITEM_INT_pull_from_##SRC ( SRC * src, pmission_item_int_MISSION_ITEM_INT * dst) {\
        pmission_item_int_seq_SET( SRC##_seq_GET(src ), dst  );\
        pmission_item_int_target_system_SET( SRC##_target_system_GET(src ), dst  );\
        pmission_item_int_target_component_SET( SRC##_target_component_GET(src ), dst  );\
        pmission_item_int_current_SET( SRC##_current_GET(src ), dst  );\
        pmission_item_int_autocontinue_SET( SRC##_autocontinue_GET(src ), dst  );\
        pmission_item_int_param1_SET( SRC##_param1_GET(src ), dst  );\
        pmission_item_int_param2_SET( SRC##_param2_GET(src ), dst  );\
        pmission_item_int_param3_SET( SRC##_param3_GET(src ), dst  );\
        pmission_item_int_param4_SET( SRC##_param4_GET(src ), dst  );\
        pmission_item_int_x_SET( SRC##_x_GET(src ), dst  );\
        pmission_item_int_y_SET( SRC##_y_GET(src ), dst  );\
        pmission_item_int_z_SET( SRC##_z_GET(src ), dst  );\
        if( SRC##_frame_item_exist(src ) )\
        pmission_item_int_frame_SET( pmission_item_int_MISSION_ITEM_INT_frame_GET( src ),  dst  );\
        if( SRC##_command_item_exist(src ) )\
        pmission_item_int_command_SET( pmission_item_int_MISSION_ITEM_INT_command_GET( src ),  dst  );\
        if( SRC##_mission_type_item_exist(src ) )\
        pmission_item_int_mission_type_SET( pmission_item_int_MISSION_ITEM_INT_mission_type_GET( src ),  dst  );\
    }
...
* Macro is expecting and calls the following functions..
static inline int64_t <SRC>_time_usec_GET( <SRC> * src ){}
static inline float <SRC>_q_GET( <SRC> * src, Vattitude_quaternion_cov_q * dst ){}
static inline float <SRC>_rollspeed_GET( <SRC> * src ){}
static inline float <SRC>_pitchspeed_GET( <SRC> * src ){}
static inline float <SRC>_yawspeed_GET( <SRC> * src ){}
static inline float <SRC>_covariance_GET( <SRC> * src, Vattitude_quaternion_cov_covariance * dst ){}
*/

#define pattitude_quaternion_cov_ATTITUDE_QUATERNION_COV_PULL_FROM(SRC)\
    static inline void pattitude_quaternion_cov_ATTITUDE_QUATERNION_COV_pull_from_##SRC ( SRC * src, pattitude_quaternion_cov_ATTITUDE_QUATERNION_COV * dst) {\
        pattitude_quaternion_cov_time_usec_SET( SRC##_time_usec_GET(src ), dst  );\
       Vattitude_quaternion_cov_q item_q = pattitude_quaternion_cov_q_SET( NULL, dst  );\
       SRC##_q_GET( src, &item_q );\
        pattitude_quaternion_cov_rollspeed_SET( SRC##_rollspeed_GET(src ), dst  );\
        pattitude_quaternion_cov_pitchspeed_SET( SRC##_pitchspeed_GET(src ), dst  );\
        pattitude_quaternion_cov_yawspeed_SET( SRC##_yawspeed_GET(src ), dst  );\
       Vattitude_quaternion_cov_covariance item_covariance = pattitude_quaternion_cov_covariance_SET( NULL, dst  );\
       SRC##_covariance_GET( src, &item_covariance );\
    }
...
#define pglobal_vision_position_estimate_GLOBAL_VISION_POSITION_ESTIMATE_PULL_FROM(SRC)\
    static inline void pglobal_vision_position_estimate_GLOBAL_VISION_POSITION_ESTIMATE_pull_from_##SRC ( SRC * src, pglobal_vision_position_estimate_GLOBAL_VISION_POSITION_ESTIMATE * dst) {\
        pglobal_vision_position_estimate_usec_SET( SRC##_usec_GET(src ), dst  );\
        pglobal_vision_position_estimate_x_SET( SRC##_x_GET(src ), dst  );\
        pglobal_vision_position_estimate_y_SET( SRC##_y_GET(src ), dst  );\
        pglobal_vision_position_estimate_z_SET( SRC##_z_GET(src ), dst  );\
        pglobal_vision_position_estimate_roll_SET( SRC##_roll_GET(src ), dst  );\
        pglobal_vision_position_estimate_pitch_SET( SRC##_pitch_GET(src ), dst  );\
        pglobal_vision_position_estimate_yaw_SET( SRC##_yaw_GET(src ), dst  );\
    }
